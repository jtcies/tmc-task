...
The type of model used to create these scores is called a classification model. The output of a classification model is really just a probability, in this case the likelihood that someone will be pro-choice. 
