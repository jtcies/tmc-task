...
There's a quote in statistics that says "All models are wrong but some are useful." We can never perfectly predict someone's beliefs, and we probably shouldn't try to. 
...
When someone wants to make decisions for a model, like which houses to canvas, they have to set a reasonable cutoff for the probability that is used to classify someone into a particular group. If they set the cutoff too high, they will have very few people in the group who shouldn't be, but they'll miss a lot of people who should be in that group. If you set it too low, you'll get the opposite: lot's of people who should be in the group aren't, but they won't miss many people who should be. So whoever is setting the cutoff has to decide which is a better. In either case though, you'll still misclassify people some of the time. 
